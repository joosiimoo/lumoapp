...
PostgreSQL is the system of record. Foundation persistence uses SQLAlchemy 2, Alembic, UUIDv7, `timestamptz`, Decimal money, and schemas `identity`, `audit`, and `platform` only.
