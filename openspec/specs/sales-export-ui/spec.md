# sales-export-ui Specification

## Purpose

Hoy offers today's CSV and XLSX downloads and shares the server file from the app temporary directory. The download is not a generative UI action.
