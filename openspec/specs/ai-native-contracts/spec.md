...
AI-native ports for Build A: LLM provider, orchestrator, tool registry, policy engine, outcome engine, and split generative UI (backend compose, Flutter render). Product tools and cards are not registered yet.
