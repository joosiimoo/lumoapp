...
Shared-schema multi-tenancy: `TenantContext` from the session, `business_id` on tenant data, and PostgreSQL RLS enforced for the FastAPI runtime role `lumo_app`.
