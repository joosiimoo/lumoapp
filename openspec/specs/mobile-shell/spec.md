...
Flutter application shell: environments, typed API client, four-tab navigation, GenerativeUIRenderer (`sale_item_added@1`, `sale_summary@1`, `sale_confirmed@1`), and a live Inicio conversation stream with a stable `conversation_id`. Hoy, Memoria, and Negocio MAY remain placeholders.
