# work-item-foundation Specification

## Purpose

Durable Daily Close WorkItems. The open set comes from today's confirmed sales and cash status and changes only inside the writes that change those facts.
